...
type PlayerIdentity =
  RouterOutputs["newPlayer"]["getPlayerTopRivals"]["rivals"][number]["opponent"];
...
type MatchEntryForInsightHref =
  | RouterOutputs["newPlayer"]["getPlayerRecentMatches"]["matches"][number]
  | RouterOutputs["newPlayer"]["getPlayerPlayedWithGroups"]["playedWithGroups"][number]["recentMatches"][number];
