...
function AddGameContent({setIsOpen}: {setIsOpen: (isOpen: boolean) => void}) {
     ...
     <View className="flex flex-col gap-4">
        ...
        <Collapsible open={moreOptions} onOpenChange={setMoreOptions} >
            <CollapsibleTrigger className="flex flex-row items-center gap-2" >
                ...
                {moreOptions ? (
                    <ChevronUp className="h-4 w-4 text-foreground" size={16}
                               strokeWidth={1.5} />
                ) : (
                    <ChevronDown className="h-4 w-4 text-foreground" size={16}
                                 strokeWidth={1.5} />
                )}
            ...
            <CollapsibleContent className="space-y-4">
                <View className="flex flex-col gap-2 pt-4">
                    ...
                    {(form.formState.errors.playersMin || form.formState.errors.playersMax) && (
                    ...
                    {(form.formState.errors.playtimeMin || form.formState.errors.playtimeMax) && (
                        <View className="space-y-2">
                    ...
                    {form.formState.errors.yearPublished && (
                        <FormMessage>{form.formState.errors.yearPublished.message}</FormMessage>
                    )}
                </View>
            </CollapsibleContent>
        </Collapsible>
