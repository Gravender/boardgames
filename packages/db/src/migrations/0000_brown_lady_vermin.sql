...
CREATE TABLE "boardgames_user" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "boardgames_user_clerk_user_id_unique" UNIQUE("clerk_user_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "boardgames_friend" ADD CONSTRAINT "boardgames_friend_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_friend" ADD CONSTRAINT "boardgames_friend_friend_id_boardgames_user_id_fk" FOREIGN KEY ("friend_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_friend_request" ADD CONSTRAINT "boardgames_friend_request_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_friend_request" ADD CONSTRAINT "boardgames_friend_request_requestee_id_boardgames_user_id_fk" FOREIGN KEY ("requestee_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_friend_setting" ADD CONSTRAINT "boardgames_friend_setting_created_by_id_boardgames_user_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_game" ADD CONSTRAINT "boardgames_game_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_game_role" ADD CONSTRAINT "boardgames_game_role_created_by_boardgames_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_group" ADD CONSTRAINT "boardgames_group_created_by_boardgames_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_image" ADD CONSTRAINT "boardgames_image_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_location" ADD CONSTRAINT "boardgames_location_created_by_boardgames_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_match" ADD CONSTRAINT "boardgames_match_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_match_image" ADD CONSTRAINT "boardgames_match_image_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_player" ADD CONSTRAINT "boardgames_player_created_by_boardgames_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_scoresheet" ADD CONSTRAINT "boardgames_scoresheet_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_share_request" ADD CONSTRAINT "boardgames_share_request_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_share_request" ADD CONSTRAINT "boardgames_share_request_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_game" ADD CONSTRAINT "boardgames_shared_game_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_game" ADD CONSTRAINT "boardgames_shared_game_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_game" ADD CONSTRAINT "boardgames_shared_game_game_id_boardgames_game_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."boardgames_game"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_shared_location" ADD CONSTRAINT "boardgames_shared_location_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_location" ADD CONSTRAINT "boardgames_shared_location_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_shared_match" ADD CONSTRAINT "boardgames_shared_match_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_match" ADD CONSTRAINT "boardgames_shared_match_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_shared_match_player" ADD CONSTRAINT "boardgames_shared_match_player_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_match_player" ADD CONSTRAINT "boardgames_shared_match_player_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_shared_player" ADD CONSTRAINT "boardgames_shared_player_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_player" ADD CONSTRAINT "boardgames_shared_player_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_shared_scoresheet" ADD CONSTRAINT "boardgames_shared_scoresheet_owner_id_boardgames_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boardgames_shared_scoresheet" ADD CONSTRAINT "boardgames_shared_scoresheet_shared_with_id_boardgames_user_id_fk" FOREIGN KEY ("shared_with_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_tag" ADD CONSTRAINT "boardgames_tag_created_by_boardgames_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boardgames_user_sharing_preference" ADD CONSTRAINT "boardgames_user_sharing_preference_user_id_boardgames_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."boardgames_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "boardgames_game_user_id_index" ON "boardgames_game" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "boardgames_image_user_id_index" ON "boardgames_image" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "boardgames_match_user_id_index" ON "boardgames_match" USING btree ("user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "boardgames_player_is_user_created_by" ON "boardgames_player" USING btree ("created_by") WHERE "boardgames_player"."is_user" = $1;--> statement-breakpoint
...
CREATE INDEX "boardgames_shared_scoresheet_id_index" ON "boardgames_shared_scoresheet" USING btree ("id");--> statement-breakpoint
CREATE INDEX "boardgames_user_clerk_user_id_index" ON "boardgames_user" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "boardgames_user_id_index" ON "boardgames_user" USING btree ("id");