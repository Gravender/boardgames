...
import { executeRequestShareGame } from "../../services/sharing/request-share-game.service";
import { validateFriendSharingPermissions } from "../../services/sharing/share-friend-validation";
import { protectedUserProcedure } from "../../trpc";
import { requestShareGameInput } from "./sharing.input";
import { requestShareGameOutput } from "./sharing.output";
import {
...
export const shareRequestRouter = {
  requestShareGame: protectedUserProcedure
    .input(requestShareGameInput)
    .output(requestShareGameOutput)
    .mutation(async ({ ctx, input }) => {
      return executeRequestShareGame({
        db: ctx.db,
        userId: ctx.userId,
        input,
      });
